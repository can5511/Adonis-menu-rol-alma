...
module.exports = class {
  ...
  async run(menu) {
      ...
      if(menu.values[0] == 'Yengeç') {
        if(!member.roles.cache.has(this.client.config.event.Yengeç)) {
          await member.roles.add(this.client.config.event.Yengeç)
          return menu.reply.send('Yengeç rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Yengeç)) {
          await member.roles.remove(this.client.config.event.Yengeç)
          return menu.reply.send("Yengeç rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Boğa') {
        if(!member.roles.cache.has(this.client.config.event.Boğa)) {
          await member.roles.add(this.client.config.event.Boğa)
          return menu.reply.send('Boğa rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Boğa)) {
          await member.roles.remove(this.client.config.event.Boğa)
          return menu.reply.send("Boğa rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'İkizler') {
        if(!member.roles.cache.has(this.client.config.event.İkizler)) {
          await member.roles.add(this.client.config.event.İkizler)
          return menu.reply.send('İkizler rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.İkizler)) {
          await member.roles.remove(this.client.config.event.İkizler)
          return menu.reply.send("İkizler rolü üzerinizden alındı.", true)
      ...
      if(menu.values[0] == 'Aslan') {
        if(!member.roles.cache.has(this.client.config.event.Aslan)) {
          await member.roles.add(this.client.config.event.Aslan)
          return menu.reply.send('Aslan rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Aslan)) {
          await member.roles.remove(this.client.config.event.Aslan)
          return menu.reply.send("Aslan rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Başak') {
        if(!member.roles.cache.has(this.client.config.event.Başak)) {
          await member.roles.add(this.client.config.event.Başak)
          return menu.reply.send('Başak rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Başak)) {
          await member.roles.remove(this.client.config.event.Başak)
          return menu.reply.send("Başak rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Terazi') {
        if(!member.roles.cache.has(this.client.config.event.Terazi)) {
          await member.roles.add(this.client.config.event.Terazi)
          return menu.reply.send('Terazi rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Terazi)) {
          await member.roles.remove(this.client.config.event.Terazi)
          return menu.reply.send("Terazi rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Akrep') {
        if(!member.roles.cache.has(this.client.config.event.Akrep)) {
          await member.roles.add(this.client.config.event.Akrep)
          return menu.reply.send('Akrep rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Akrep)) {
          await member.roles.remove(this.client.config.event.Akrep)
          return menu.reply.send("Akrep rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Yay') {
        if(!member.roles.cache.has(this.client.config.event.Yay)) {
          await member.roles.add(this.client.config.event.Yay)
          return menu.reply.send('Yay rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Yay)) {
          await member.roles.remove(this.client.config.event.Yay)
          return menu.reply.send("Yay rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Oğlak') {
        if(!member.roles.cache.has(this.client.config.event.Oğlak)) {
          await member.roles.add(this.client.config.event.Oğlak)
          return menu.reply.send('Oğlak rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Oğlak)) {
          await member.roles.remove(this.client.config.event.Oğlak)
          return menu.reply.send("Oğlak rolü üzerinizden alındı.", true)
    
        }
      }
      if(menu.values[0] == 'Kova') {
        if(!member.roles.cache.has(this.client.config.event.Kova)) {
          await member.roles.add(this.client.config.event.Kova)
          return menu.reply.send('Kova rolü üzerinize verildi.', true)
        } else if(member.roles.cache.has(this.client.config.event.Kova)) {
          await member.roles.remove(this.client.config.event.Kova)
          return menu.reply.send("Kova rolü üzerinizden alındı.", true)
      ...
      if(menu.values[0] == 'Balık') {
        if(!member.roles.cache.has(this.client.config.event.Vampirkoylu)) {
          ...
          return menu.reply.send('Vampir rolü üzerinize verildi.', true)
          ...
          return menu.reply.send("Vampir rolü üzerinizden alındı.", true)
